...
console.log('🕋 100% HALAL EXNESS BOT - COMPLETE FIX');
console.log('📦 Version: 39.0.0');
console.log('✅ CORRECT BALANCE + TRADING WORKING');
...
class TradingEngine {
    ...
    async executeTrade(symbol, side, signal) {
        try {
            ...
            const positionSize = Math.max(3, Math.min(balance / 5, balance * 0.15));
...
app.listen(PORT, '0.0.0.0', () => {
    console.log(`\n🕋 100% HALAL EXNESS BOT – COMPLETE FIX`);
